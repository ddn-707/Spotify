...
class APICaller {
    ...
    //MARK: - PLAYLIST
    public func getPlaylistDetails(for playlist: Playlist, completion: @escaping(
    Result<PlaylistDetailsReponse, Error>)-> Void){
        let stringURL = Constants.baseAPIURL + "/playlists/" + playlist.id
        print(stringURL)
        createRequest(
